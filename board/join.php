...
$conn = new mysqli("localhost","root","#ehd256836","web");
...
if($hiddenid == 1) {
$sql = "select *from web.member where id = '$id'";
$res = $conn->query($sql);
if($res -> num_rows > 0) {
...
if($hiddennickname == 1) {
$sql2 = "select *from web.member where nickname = '$nickname'";
...
$sql3 = "insert into web.member (id,nickname,password) values ('$id','$nickname','$password')";
$res3 = $conn->query($sql3);
$sql4 = "select *from web.member where id = '$id' and nickname='$nickname'";

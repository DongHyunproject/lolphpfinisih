...
<div id="board_area">
    ...
    <h4 style="margin-top:30px;"><a href="/howtoboard/index.php">Community 게시판으로</a></h4>
		...
		while($board = $sql2->fetch_array()){
            ...
            <tr>
                ...
                <td width="500">
					...
					{ ?><a href='/howtoboard/secret_read.php.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
						}else{?>
						...
						?>
                        <!--- 추가부분 18.08.01 END -->
                        <a href='/howtoboard/read.php?idx=<?php echo $board["idx"]; ?>'><span style="background:yellow;"><?php echo $title; }?></span><span class="re_ct">[<?php echo $rep_count;?>]<?php echo $img; ?> </span></a></td>
